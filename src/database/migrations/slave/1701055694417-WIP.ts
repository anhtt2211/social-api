...
export class WIP1701055694417 implements MigrationInterface {
    name = 'WIP1701055694417'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "file" DROP CONSTRAINT "FK_df950727221b7c53576e03800d8"`);
