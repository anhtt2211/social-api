...
export class wip1672246339821 implements MigrationInterface {
    name = 'wip1672246339821'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."block_type_enum" RENAME TO "block_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."block_type_enum" AS ENUM('paragraph', 'image', 'smallerHeader', 'text', 'quote', 'delimiter')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."block_type_enum_old" AS ENUM('paragraph', 'image', 'smallerHeader', 'text', 'quote')`);
        await queryRunner.query(`ALTER TABLE "block" ALTER COLUMN "type" DROP DEFAULT`);
